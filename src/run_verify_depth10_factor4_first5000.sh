...
WORK="${1:-${TMPDIR:-/tmp}/erdos_depth10_factor4_first5000}"
CXX="${CXX:-g++}"
...
$CXX -O3 -std=c++17 -fopenmp \
  "$ROOT/src/verify_depth10_factor4_positions_1001_5000.cpp" \
  -o "$WORK/verify_positions_1001_5000"
...
"$WORK/verify_positions_1001_5000" \
  "$WORK/depth10_factor4_positions_1001_5000_witnesses.txt"

sha256sum "$WORK/depth10_factor4_positions_101_1000_witnesses.txt"
sha256sum "$WORK/depth10_factor4_positions_1001_5000_witnesses.txt"

echo "verified: first 5000 genuinely new S10 factor-four candidates"
