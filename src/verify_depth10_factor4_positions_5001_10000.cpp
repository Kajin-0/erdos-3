...
constexpr int PRIOR_COUNT=5000,EXPECTED_TOTAL=10000,EXPECTED_COUNT=5000;
constexpr int EXPECTED_FIRST=76646153,EXPECTED_LAST=76697408;
...
constexpr uint64_t EXPECTED_WITNESS_FNV=0xce7f765c19d63adeULL;
constexpr long long EXPECTED_TOTAL_TRIALS=510227717,EXPECTED_MAX_TRIALS=914319;
constexpr int EXPECTED_MAX_TRIAL_R=76694747;
...
int main(int argc,char**argv){try{
 ...
 string certificate;certificate.reserve(280000);long long total_trials=0,max_trials=0;int max_trial_R=0;
 ...
 cout<<"verified: S10 factor-four domain positions 5001-10000\n";
 cout<<"first_R="<<domain[PRIOR_COUNT]<<"\nlast_R="<<domain.back()<<"\nexplicit_witnesses="<<EXPECTED_COUNT<<"\n";
 cout<<"witness_fnv64=ce7f765c19d63ade\n";
